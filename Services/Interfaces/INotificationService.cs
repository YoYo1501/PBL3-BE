...
public interface INotificationService
{
    ...
    Task<int> CreateForAdminsAsync(string title, string message);
    ...
    Task<PagedResultDto<NotificationResponseDto>> GetMyPagedNotificationsAsync(int userId, NotificationFilterDto filter);
